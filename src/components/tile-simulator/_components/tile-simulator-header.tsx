    ...
    <div className="w-full space-y-2 md:space-y-0 lg:space-y-0 md:flex lg:flex itmes-center gap-5">
      ...
      <div className="relative">
        ...
        <Input
          ...
          className={cn(
            "pl-10   2xl:h-[52px]", // Added pr-10 to make room for the clear icon
            "border-primary",
      ...
      {/* add border  */}
      <div>
        <button className="flex w-full p-4 items-center gap-[14px] text-base font-medium leading-[120%] text-primary border border-primary rounded-[8px] py-2 xl:py-[10px] 2xl:h-[52px]  px-[30px] md:px-[40px] lg:px-[50px] xl:px-[60px] 2xl:px-[70px] ">
